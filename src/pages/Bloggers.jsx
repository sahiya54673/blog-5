...
const Bloggers = () => {
  ...
  return (
    <main className="page page--bloggers">
      <div className="bloggers-bg">
        <div className="bloggers-bg__item"></div>
        <div className="bloggers-bg__item"></div>
        <div className="bloggers-bg__item"></div>
      </div>

      <div className="page__header" style={{ textAlign: 'center', flexDirection: 'column', gap: '1rem', marginBottom: '4rem', position: 'relative', zIndex: 1 }}>
      ...
      <div className="blogger-grid">
        {bloggers.map(blogger => (
          <div key={blogger.id} className={`blogger-card blogger-card--${blogger.colorTheme}`}>
